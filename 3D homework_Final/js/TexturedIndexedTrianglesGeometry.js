let TexturedIndexedTrianglesGeometry = function (gl, jsonMesh) {
    this.vertices = jsonMesh.vertices;
    this.normals = jsonMesh.normals;
    this.textureCoords = jsonMesh.texturecoords;
    var indices = [].concat.apply([], jsonMesh.faces);
    ...
    gl.bufferData(gl.ARRAY_BUFFER,
      new Float32Array(this.vertices), gl.STATIC_DRAW); // static as vertices will never change
  /*
    // vertex color
